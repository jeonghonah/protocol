...
public final class AuthClient {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return AuthClient.internal_static_VoxelSrvMessage_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return AuthClient.internal_static_VoxelSrvMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AuthClient.VoxelSrvMessage.class, AuthClient.VoxelSrvMessage.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AuthClient.VoxelSrvMessage)) {
        return super.equals(obj);
      }
      AuthClient.VoxelSrvMessage other = (AuthClient.VoxelSrvMessage) obj;
    ...
    public static AuthClient.VoxelSrvMessage parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static AuthClient.VoxelSrvMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AuthClient.VoxelSrvMessage parseFrom(
    ...
    public static AuthClient.VoxelSrvMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static AuthClient.VoxelSrvMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AuthClient.VoxelSrvMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AuthClient.VoxelSrvMessage prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        AuthClient.VoxelSrvMessageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AuthClient.internal_static_VoxelSrvMessage_descriptor;
      }
      ...
      // Construct using AuthClient.VoxelSrvMessage.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public AuthClient.VoxelSrvMessage getDefaultInstanceForType() {
        return AuthClient.VoxelSrvMessage.getDefaultInstance();
      }

      @java.lang.Override
      public AuthClient.VoxelSrvMessage build() {
        AuthClient.VoxelSrvMessage result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public AuthClient.VoxelSrvMessage buildPartial() {
        AuthClient.VoxelSrvMessage result = new AuthClient.VoxelSrvMessage(this);
        result.message_ = message_;
        onBuilt();
        return result;
      }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AuthClient.VoxelSrvMessage) {
          return mergeFrom((AuthClient.VoxelSrvMessage)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(AuthClient.VoxelSrvMessage other) {
        if (other == AuthClient.VoxelSrvMessage.getDefaultInstance()) return this;
        if (other.getMessage() != com.google.protobuf.ByteString.EMPTY) {
          setMessage(other.getMessage());
        }
        this.mergeUnknownFields(other.unknownFields);
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AuthClient.VoxelSrvMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AuthClient.VoxelSrvMessage) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    private static final AuthClient.VoxelSrvMessage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AuthClient.VoxelSrvMessage();
    }

    public static AuthClient.VoxelSrvMessage getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
