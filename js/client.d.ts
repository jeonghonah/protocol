...
export interface IActionInventoryCheat {

    /** ActionInventoryCheat id */
    id?: (string|null);
}

/** Represents an ActionInventoryCheat. */
export class ActionInventoryCheat implements IActionInventoryCheat {

    /**
     * Constructs a new ActionInventoryCheat.
     * @param [properties] Properties to set
     */
    constructor(properties?: IActionInventoryCheat);
     ...
     * @param [properties] Properties to set
     * @returns ActionInventoryCheat instance
     */
    public static create(properties?: IActionInventoryCheat): ActionInventoryCheat;

    /**
     * Encodes the specified ActionInventoryCheat message. Does not implicitly {@link ActionInventoryCheat.verify|verify} messages.
     * @param message ActionInventoryCheat message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: IActionInventoryCheat, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: IActionInventoryCheat, writer?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes an ActionInventoryCheat message from the specified reader or buffer.
     * @param reader Reader or buffer to decode from
     * @param [length] Message length if known beforehand
     * @returns ActionInventoryCheat
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): ActionInventoryCheat;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): ActionInventoryCheat;
     ...
     * @returns ActionInventoryCheat
     */
    public static fromObject(object: { [k: string]: any }): ActionInventoryCheat;

    /**
     * Creates a plain object from an ActionInventoryCheat message. Also converts values to other types if specified.
     * @param message ActionInventoryCheat
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: ActionInventoryCheat, options?: $protobuf.IConversionOptions): { [k: string]: any };
...
export interface ISoundStatusResponce {
...
/** Represents a SoundStatusResponce. */
export class SoundStatusResponce implements ISoundStatusResponce {

    /**
     * Constructs a new SoundStatusResponce.
     * @param [properties] Properties to set
     */
    constructor(properties?: ISoundStatusResponce);
     ...
     * @param [properties] Properties to set
     * @returns SoundStatusResponce instance
     */
    public static create(properties?: ISoundStatusResponce): SoundStatusResponce;

    /**
     * Encodes the specified SoundStatusResponce message. Does not implicitly {@link SoundStatusResponce.verify|verify} messages.
     * @param message SoundStatusResponce message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: ISoundStatusResponce, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: ISoundStatusResponce, writer?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a SoundStatusResponce message from the specified reader or buffer.
     * @param reader Reader or buffer to decode from
     * @param [length] Message length if known beforehand
     * @returns SoundStatusResponce
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): SoundStatusResponce;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): SoundStatusResponce;
     ...
     * @returns SoundStatusResponce
     */
    public static fromObject(object: { [k: string]: any }): SoundStatusResponce;

    /**
     * Creates a plain object from a SoundStatusResponce message. Also converts values to other types if specified.
     * @param message SoundStatusResponce
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: SoundStatusResponce, options?: $protobuf.IConversionOptions): { [k: string]: any };
